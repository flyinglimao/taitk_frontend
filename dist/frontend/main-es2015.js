...
let AlgorithmService = class AlgorithmService {
    ...
    list(page = 1, full = false) {
        let self = this;
        let api = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].api}algorithms?`;
    ...
    get(id) {
        ...
        let api = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].api}algorithms/${id}`;
        return new Promise(function (resolve, reject) {
    ...
    update(data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log('eqw');
            let self = this;
            let api = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].api}algorithms/${data.id}`;
            let oldData = (yield this.get(data.id));
    ...
    handleTags(id, data, oldData) {
        let self = this;
        let api = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].api}algorithms/${id}/tags`;
    ...
    handleLinks(id, data, oldData) {
        let self = this;
        let api = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].api}algorithms/${id}/links`;
    ...
    handleDatasets(id, data, oldData) {
        let self = this;
        let api = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].api}algorithms/${id}/datasets`;
    ...
    handleParameters(id, data, oldData) {
        let self = this;
        let api = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].api}algorithms/${id}/parameters`;
        data.forEach((dataset, index) => {
            dataset['token'] = this.userService.token;
            if (dataset.id === -1) {
                self.httpClient.post(api, dataset).subscribe();
    ...
    createAttribute(attr, id, data) {
        if (data.delete) {
            return;
        }
        let api = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].api}algorithms/${id}/${attr}`;
        data['token'] = this.userService.token;
        this.httpClient.post(api, data).subscribe();
    }
    updateAttribute(attr, id, subid, data) {
        let api = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].api}algorithms/${id}/${attr}/${subid}`;
        data['token'] = this.userService.token;
        this.httpClient.patch(api, data).subscribe();
    }
    deleteAttribute(attr, id, subid) {
        let api = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].api}algorithms/${id}/${attr}/${subid}`;
...
let AlgorithmsComponent = class AlgorithmsComponent {
    constructor(userService, algorithmService, router, route) {
        this.userService = userService;
            ...
            self.route.paramMap.subscribe(e => {
                ...
                this.route.fragment.subscribe((fragment) => {
                    if (!self.userService.logined || fragment === 'all') {
                        self.full = true;
                        self.algorithmService.list(null, true).then((data) => {
                        ...
                        self.algorithmService.list().then((data) => {
                            self.algorithms = [...data];
    ...
    finishEdit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.algorithm.id === -1) {
                try {
                    let id = yield this.algorithmService.create(this.algorithm);
...
let AlgorithmExampleComponent = class AlgorithmExampleComponent {
    constructor() {
...
let AlgorithmFormComponent = class AlgorithmFormComponent {
...
let Dataset2019Component = class Dataset2019Component {
...
let NewsInfoComponent = class NewsInfoComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let UserService = class UserService {
    constructor(httpClient) {
        ...
        if (localStorage.getItem('token')) {
            let request = httpClient.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api}auth/status`, { params: {
    ...
    registerInitedCallback(callback) {
        if (this.inited)
            callback();
        else
    ...
    login(email, group) {
        let self = this;
        return new Promise(function (resolve, reject) {
            let request = self.httpClient.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api}auth/login`, { email: email, group: group });
            request.subscribe(function (data) {
                if (data.success) {
    ...
    logout() {
        let self = this;
        return new Promise(function (resolve, reject) {
            let request = self.httpClient.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api}auth/logout`, { token: self.token });
            request.subscribe(function (data) {
                if (data.success) {
                    self._token = '';
                    self._logined = false;
    ...
    register(data) {
        let self = this;
        return new Promise(function (resolve, reject) {
            let request = self.httpClient.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api}auth/register`, data);
            request.subscribe(function (data) {
                if (data.success) {
                    self._token = data.token;
                    self._logined = true;
